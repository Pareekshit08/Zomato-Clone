...
import "../../styles/restaurent/FrequentQues.css";
...
const FrequentQues = () => {
  ...
  const questions = [
    ...
    },
    {
      ...
      answer: "You can contact our support team through the Zomato app or email us at support@Zomato.com for assistance.",
    },
    {
    ...
    },
    {
      ...
      answer: "Payouts are transferred weekly to your registered bank account. You can also track payouts in the Zomato app.",
    },
  ];
